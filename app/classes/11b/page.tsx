...
const sourceSections: ClassReportSection[] = [
  {
    ...
    achievements: [
      { badge: "Эх баримт", name: "БТА Л. Эгиймаа багштай 11В ангийн танилцуулга" },
      { badge: "Эх баримт", name: "Ариун цэврийн дарга: Б. Анирлан" },
      { badge: "Эх баримт", name: "Ангийн нийт сурагчид сурлага, урлаг, спортоор тэргүүний сурагчид төдийгүй хүмүүжил төлөвшил сайтай сурагчид юм. Анги болон сургуулиас зохион байгуулсан ажлууд болон нийгмийн сайн сайхны төлөөх сайн дурын ажилд идэвхтэй оролцдог сургуулийн шилдэг анги хамт олны нэг билээ." },
      { badge: "Эх баримт", name: "Буухай гүйлтийн төрөлд Мөнгөн медаль" },
      { badge: "Эх баримт", name: "мет рийн гүйлт Хүрэл медаль М. Эрхсаран" },
      { badge: "Эх баримт", name: "Солонгос улсад зохион байгуулагдсан Pease Cheorwon Volleyball Challenge 2025 тэмцээн Т эргүүн байр С. Амартүвшин" },
      { badge: "Эх баримт", name: "Хүүхдийн номын сангаас зохион байгуулсан “Соёл түгээе” у риатай үндэсний бахархалт амьтан мазаалайг хамгаалах “Мазаалай пост”-н уралдаанд" },
      { badge: "Эх баримт", name: "Монгол бахархалын 7 хоног" },
      { badge: "Эх баримт", name: "Багийн дүнгээр" },
      { badge: "Эх баримт", name: "Шилжин явах цомын эзэн Аварга анги" },
      { badge: "Эх баримт", name: "“Цэлмэгийн авьяастууд” Урлагийн наадам" },
      { badge: "Эх баримт", name: "Хөгжмийн төрөлд 2-р байр" },
      { badge: "Эх баримт", name: "Авьяаслаг сурагч Б. Баяр Ж. Төгөлдөр М. Энхзаяа нар тодорлоо." },
      { badge: "Эх баримт", name: "Хичээлээс гадуурх сайн дурын 4 төрлийн ажлыг ангиараа хамтран хийж оролцлоо." },
    ],
    images: [],
  },
  {
    ...
    achievements: [
      { badge: "Эх баримт", name: "“ Open day ” С ургуулийн нээлттэй хаалга ны өдөрлөгийн арга хэмжээнд ангиараа хөтөчөөр ажиллав." },
      { badge: "Эх баримт", name: "ОУ-н Ихрүүдийн баярын өдрөөр 103 төвийн 53 ихэр хүүхдэд анги хамт олноороо гарын бэлэг, бэлэн мөнгийг тусламж болгон цуглуулж ангийн дарга Б. Золбоот төлөөлөн хүргэж өглөө." },
      { badge: "Эх баримт", name: "ХУД-н Рубик шооны аварга шалгаруулах тэмцээнд сайн дурын ажил хийсэн." },
      { badge: "Эх баримт", name: "ХУД-н Рубик шооны аварга шалгаруулах тэмцээнд сайн дурын ажил хийсэн." },
      { badge: "Эх баримт", name: "ХУД-н Рубик шооны аварга шалгаруулах тэмцээнд сайн дурын ажил хийсэн." },
      { badge: "Эх баримт", name: "ХУД-н Рубик шооны аварга шалгаруулах тэмцээнд сайн дурын ажил хийсэн." },
      { badge: "Эх баримт", name: "Дэлхийн усны өдөр болон Монгол хүн анх сансарт ниссэн өдөрт зориулсан гар зургийн уралдаан Ахлах насны төрөлд Шилдэг бүтээл Тэргүүн байр А. Нандин-Эрдэнэ" },
      { badge: "Эх баримт", name: "HUGO and COLOR Гар зургийн олимпиадад амжилттай оролцож Авьяаслаг хүүхэд 5-р зэрэг А . Нандин-Эрдэнэ" },
      { badge: "Эх баримт", name: "Дизайн, Зурагзүйн Онлайн Олим пиад XX" },
      { badge: "Эх баримт", name: "Мултимедиа төрөлд" },
      { badge: "Эх баримт", name: "11В ангийн сурагч Э. Уянга нь дараах олимпиадад" },
      { badge: "Эх баримт", name: "Монголын математик олимпиадын 1-р шатанд тэнцсэн" },
      { badge: "Эх баримт", name: "ХУД-н Үндэсний бичгийн олимпиадад сургуулиас шалгаран оролцсон." },
      { badge: "Эх баримт", name: "“Цэлмэгийн гоёо- 2026” Хувцас загвар зохион бүтээгч, загвар өмсөгчдийн тэмцээн" },
    ],
    images: [],
  },
  {
    ...
    achievements: [
      { badge: "Эх баримт", name: "Авангард хувцасны төрөлд" },
      { badge: "Эх баримт", name: "Гоёлын хувцасны төрөлд" },
      { badge: "Эх баримт", name: "Кенгуру цахим олимпиад 1 ,2 -р зэрэг авсан сурагчид" },
      { badge: "Эх баримт", name: "Манай ангийн сурагчид сургуулийн сурагчдын өөрөө удирдах түвшинд амжилттай ажилладаг." },
      { badge: "Эх баримт", name: "Номын баярт зориулсан ном хандивлах, уншсан номоо солилцох, худалдах үйл ажиллагаанд оролцов." },
      { badge: "Эх баримт", name: "ЭРДЭНЭТ үйлдвэртэй танилцах аялалд оролцов." },
      { badge: "Эх баримт", name: "ЭРДЭНЭТ үйлдвэртэй танилцах аялалд оролцов." },
    ],
    images: [],
  }
