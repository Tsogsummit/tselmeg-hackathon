...
const sections: ClassReportSection[] = [
  {
    ...
    achievements: [
      { badge: "Амжилттай тэнцсэн", name: "23 сурагч", event: "Хятад хэлний HSK2 түвшний шалгалт" },
    ],
    images: [],
  },
  {
    ...
    images: [{ src: "/slides/7c/image1.jpeg", caption: "“Сурагч нас - 2026” бүжгийн их наадам" }],
  },
  {
    id: "rubik",
    tone: "purple",
...
export default function SevenCPage() {
  return (
    <StaticClassReport
      ...
      intro={
        <>
          7С анги нь 17 эрэгтэй, 8 эмэгтэй нийт <span className="font-black text-brand-navy">25 сурагчтай</span>. Хэл, урлаг, спорт, цахим спорт, олимпиадын чиглэлүүдээр идэвхтэй оролцож олон төрлийн амжилт гаргасан хамт олон.
        </>
      }
      sections={sections}
